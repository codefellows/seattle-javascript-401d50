...
Configure your Heroku deployments via the [Heroku GUI](https://codefellows.github.io/code-401-javascript-guide/curriculum/class-01/heroku-gui-configuration.md){:target="_blank"} or [Heroku CLI](https://codefellows.github.io/code-401-javascript-guide/curriculum/class-01/heroku-cli-deployment.md){:target="_blank"}.
